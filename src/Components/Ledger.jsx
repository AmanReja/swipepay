        ...
        <section className="w-full flex flex-col sm:flex-col gap-[20px] mt-[20px] sm:min-h-[600px] 2xl:h-[780px] sm:h-[600px] px-[2px] sm:px-[20px]">
          ...
          >
            <div className="flex flex-col w-full mb-4">
              ...
              >
                Overview of all wallet transactions including balance changes,
                status, and date.
              </p>
              ...
              >
                ...
                <div className="flex gap-3 flex-wrap items-center">
                  ...
                  <div className="relative w-[180px]">
                    ...
                    {open && (
                      <ul
                        className={` fixed open w-[200px] left-[400px] right-0 mt-2 rounded-lg shadow-lg border z-20 max-h-80 overflow-y-auto ${
                          theme === "dark"
