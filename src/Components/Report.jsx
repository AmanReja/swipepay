...
const Report = () => {
  ...
  const payoutdatareport = useSelector((state) => state.payoutlog.payoutlog.summary);
  ...
  console.log(92,payoutdatareport);
  ...
  return (
    ...
    <span class="sr-only">Loading...</span>
              ...
              {
                label: "Payout Value",
                value: "₹"+ payoutdatareport?.total_payout_value || "0.00",
              },
              {
                label: "Success Rate",
                value: `${payoutdatareport?.success_rate
                  === undefined
                    ? "00"
                    : payoutdatareport?.success_rate +"%"
                  }`,
              },
              {
                label: "Pending Payouts",
                value: "₹"+ payoutdatareport?.pending_value || "0.00",
              },
              {
                label: "Failure",
                value:"₹"+ payoutdatareport?.failed_value || "0.00",
              },
            ].map((item, index) => (
              <div
                key={index}
