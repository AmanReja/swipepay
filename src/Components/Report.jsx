...
const Report = () => {
  ...
  const payoutlogreport = useSelector((state) => state.payoutlog.payoutlog.summary
  );
  ...
  const totalpage = useSelector((state) => state.payoutlog.payoutlog.
  pagination
  ?.
  totalPages
...
>
  ...
  <div className="flex flex-col">
    ...
    >
      Overview of all payout transactions including status, amount, and date.
    </p>
  </div>
  ...
  {/* Info stats */}
    ...
    <span class="sr-only">Loading...</span>
          ...
          </div>)): [
            {
              ...
              value:payoutlogreport?.total_payout_value != null
                ? Number(payoutlogreport.total_payout_value).toLocaleString('en-US', {
            ...
            {
              label: "Success Rate",
              value: `${payoutlogreport?.success_rate
                === undefined
                  ? "00"
            ...
            },
            {
              ...
              value:payoutlogreport?.pending_value != null
              ? Number(payoutlogreport.pending_value).toLocaleString('en-US', {
                  minimumFractionDigits: 2,
                  maximumFractionDigits: 2,
                })
              : '0.00'
            ...
            },
            {
              ...
              value:payoutlogreport?.failed_value != null
              ? Number(payoutlogreport.failed_value).toLocaleString('en-US', {
                  minimumFractionDigits: 2,
                  maximumFractionDigits: 2,
                })
              : '0.00'
              ...
              >
                ...
                >
                  <tr>
                    ...
                    <th className="px-4 py-3">Charges
                    </th>
                  </tr>
                </thead>
                    ...
                    : payoutlogdata?.map((txn, i) => (
                      ...
                      >
                        <td className="px-4 py-2">
                          <span
                            className={`text-white rounded-[3px] px-[13px] py-[2px] text-center min-w-[80px] font-bold text-[12px] ${txn.status.toUpperCase() === "SUCCESS"
                              ? "bg-green-400"
                        ...
                        <td className="px-4 py-5">{txn.txn_date
                        }</td>
                        ...
                        <td className="px-4 py-5">
                          <div className="flex flex-col">
                            ...
                            <p>[IFSC Code: {txn.ifsc_code

                            }]</p>
                          </div>
                        </td>
                        <td className="px-4 py-5">{txn.settlement_amount != null
  ? Number(txn.settlement_amount).toLocaleString('en-US', {
      minimumFractionDigits: 2,
      maximumFractionDigits: 2,
    })
  : '0.00'}
</td>
                        <td className="px-4 py-5">{txn.settlement_charge != null
                          ? Number(txn.settlement_charge).toLocaleString('en-US', {
                              minimumFractionDigits: 2,
                              maximumFractionDigits: 2,
                            })
                          : '0.00'}
