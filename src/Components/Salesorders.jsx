          ...
          >
            ...
            <motion.div variants={fade} className="w-full lg:w-1/2">
              ...
              <motion.ul variants={stagger} className="flex flex-col gap-3 text-[15px]">
                {[
                  "Record customer requests accurately",
                               "Share sales order to customer easily",
                  "Convert sales orders to invoices in one click for faster billing",
                ].map((text, index) => (
                  <motion.li
                    key={index}
                    variants={fade}
