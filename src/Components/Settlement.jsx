...
import { ChevronDown, Check,ChevronLeft ,ChevronRight,Wallet } from "lucide-react";
import {motion}from "framer-motion";
import pngsettlement from "../assets/images/settlement.png"
  ...
  return (
    ...
    >
      <main className="w-full h-full flex flex-col overflow-y-scroll">
        ...
        transition={{ duration: 0.8 }} className="min-h-[200px] relative overflow-hidden rounded-xl p-8 md:p-10 flex flex-col md:flex-row items-center justify-between gap-8 bg-gradient-to-br from-emerald-900 via-emerald-800 to-emerald-700 shadow-2xl">
      ...
      <div className="flex flex-col gap-4 text-center md:text-left max-w-2xl">
        <h1 style={{fontFamily:"montserrat"}} className="text-2xl md:text-3xl font-bold text-white tracking-tight">
          Settlement Details
        </h1>
        <p style={{fontFamily:"montserrat"}} className="text-sm md:text-base text-gray-200 leading-relaxed">
          View complete settlement insights including payout summaries, pending
          settlements, transaction cycles, and settlement history. Stay updated
          with transparent financial reporting.
        </p>
      </div>

      {/* ICON */}
      <Wallet className="w-24 h-24 text-white drop-shadow-lg" />
      {/* <img className="w-24 h-34 object-cover" src={pngsettlement} alt="" /> */}
    </motion.div >
          {/* <div
