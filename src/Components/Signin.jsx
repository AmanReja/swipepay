    ...
    <div className="h-screen w-full flex bg-gradient-to-br from-[#0f1d45] to-[#381a81] font-sans">
      ...
      <div className="flex flex-col w-full sm:w-1/2 justify-center items-center px-6">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-10 w-full max-w-md">
          ...
          >
<div role="status">
    <svg aria-hidden="true" class="inline w-8 h-8 text-neutral-tertiary animate-spin fill-dark dark:fill-quaternary" viewBox="0 0 100 101" fill="blue" xmlns="http://www.w3.org/2000/svg">
