...
const Subscriptions = ({ theme }) => {
  ...
  return (
    ...
    >
      ...
      <motion.div
        variants={fadeIn}
        className="bg-purple-500 w-full h-[50px] min-h-[40px] rounded-[5px] 
      ...
      >
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.95 }}
          className="w-[180px] rounded-2xl bg-white shadow-2xs text-purple-600 font-semibold"
        >
          Upgrade Now 🚀
        </motion.button>
      </motion.div>
        ...
        <div className="flex flex-col bg-white rounded-[10px] dark:bg-gray-900 p-4">
          ...
          >
            <h1 className="text-2xl font-semibold">
              Subscriptions & Billing <span className="text-purple-600">▶</span>
            </h1>
          ...
          >
            ...
            <motion.div variants={slideRight} className="w-full lg:w-1/2">
              ...
              <motion.ul variants={stagger} className="flex flex-col gap-3 text-[15px]">
                {[
                  "Access unlimited invoicing & advanced reports",
                  "Manage staff, logs, audit trails, and permissions",
