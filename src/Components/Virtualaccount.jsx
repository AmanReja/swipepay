...
const Virtualaccount = () => {
  ...
  useEffect(() => {
    ...
    async function fetch() {
      ...
      await dispatch(getall_virtual_account_txn( searchtr,
        trstatus,
        formdatastr,
        formdataend,
        false,
  ...
  >
    Overview of all Virtual transactions including transaction ID, amount, status, and date.
  </p>
              ...
              >
                ...
                <div className="flex gap-3 flex-wrap items-center">
                  ...
                  >
                    ...
                    >
                      <option selected className={`${theme === "dark" ? "bg-gray-800 text-white" : "bg-white text-gray-800"}`} value="All">All</option>
                      <option className={`${theme === "dark" ? "bg-gray-800 text-white" : "bg-white text-gray-800"}`} value="active">ACTIVE</option>
                      <option className={`${theme === "dark" ? "bg-gray-800 text-white" : "bg-white text-gray-800"}`} value="inactive">INACTIVE</option>
                ...
                {load ? (
                  ...
                  virtualdata.map((txn, i) => (
                    ...
                    >
                      ...
                      <td className="px-4 py-4"><div className="space-y-2">
                          <p
                            className={`text-sm font-medium flex flex-col ${
                              theme === "dark"
                                ? "text-gray-200"
                      ...
                      <td className="px-4 py-4">
                        <span
                          className={`text-white rounded-[4px]   min-w-[80px] text-center px-[5px] py-[2px] font-bold text-[12px] ${
            ...
            {virtotalpages > 0 ? (
              ...
              >
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <p>
                    {(page - 1) * perPage + 1}-
                    {Math.min(page * perPage, totalvirdatarecord)} of {totalvirdatarecord}
                  </p>
